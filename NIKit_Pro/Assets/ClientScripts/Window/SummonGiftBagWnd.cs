...
public class SummonGiftBagWnd : WindowBase<SummonGiftBagWnd>
{
    // 礼包标题
    ...
    void RegisterEvent()
    {
        ...
        EventMgr.RegisterEvent("SummonGiftBagWnd", EventMgrEventType.EVENT_BUY_ITEM_SUCCESS, OnBuyItemSuccCallBack);
    }
