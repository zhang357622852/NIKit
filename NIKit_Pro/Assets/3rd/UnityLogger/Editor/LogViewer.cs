    ...
    public class LogViewer : EditorWindow
    {
        ...
        private void RenderBody(List<LogMessage> messages, int pageSize)
        {
            ...
            foreach (LogMessage logMessage in messages)
            {
                ...
                else if (activeMessage == logMessage)
                {
        ...
        private void InitializeStyles()
        {
            ...
            numberStyleSelected.fontSize = 12;
            ...
            messageDetailStyle.fontSize = 12;
            ...
            messageDetailStyleSelected.fontSize = 12;
        ...
        private void HandleKeys()
        {
            ...
            else if (Event.current.type == EventType.KeyUp)
            {
                ...
                else if (Event.current.keyCode == KeyCode.Pause)
                {
                    pauseFrame = logMessages;
                }
        ...
        public void HandleLog(string logString, string stackTrace, LogType type)
        {
            ...
            else if (type == LogType.Warning || type == LogType.Assert)
            {
